...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>SAP/PushResults.m at f5277bf3ee75685f08917b7b8cd1d8c37f0756aa · mradhub/SAP</title>
...
<meta content="/EShUKdqbK9cV3w+olnYggPu/jfhS2t3kuRa874w0Fc=" name="csrf-token" />
    ...
    <script defer="defer" src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-0e05654676da76742ed92db3a771c57b6d399374.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/mradhub/SAP/blob/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PushResults.m'>
            ...
            <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field">
              <div class="no-results js-not-filterable">Nothing to show</div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/mradhub/SAP/blob/master/PushResults.m" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
            </div>
...
<!-- block_view_fragment_key: views10/v8/blob:v21:21739efec929247c9f27f3b26d6fc92f -->
  <div id="slider">

    <div class="breadcrumb" data-path="PushResults.m/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/mradhub/SAP/tree/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa" class="js-rewrite-sha" itemprop="url"><span itemprop="title">SAP</span></a></b> / <strong class="final-path">PushResults.m</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="PushResults.m" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>


      <div class="commit file-history-tease" data-path="PushResults.m/">
        ...
        <time class="js-relative-date" datetime="2012-06-13T09:36:37-07:00" title="2012-06-13 09:36:37">June 13, 2012</time>
        <div class="commit-title">
            <a href="/mradhub/SAP/commit/b6cdfbcb4673c37af5d01abef5f0762d5cf2efc3" class="message">try 5</a>
        </div>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="PushResults.m/" data-permalink-url="/mradhub/SAP/blob/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PushResults.m" data-title="SAP/PushResults.m at f5277bf3ee75685f08917b7b8cd1d8c37f0756aa · mradhub/SAP · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/mradhub/SAP/edit/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PushResults.m" data-method="post" rel="nofollow" data-hotkey="e">Edit this file</a>
                  </li>

                <li>
                  <a href="/mradhub/SAP/raw/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PushResults.m" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span class="icon"></span>Raw</a>
                </li>
                  <li>
                    <a href="/mradhub/SAP/blame/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PushResults.m" class="minibutton btn-blame grouped-button bigger lighter"><span class="icon"></span>Blame</a>
                  </li>
                <li>
                  <a href="/mradhub/SAP/commits/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PushResults.m" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span class="icon"></span>History</a>
                </li>
              </ul>
            </div>
...
<span id="L13" rel="#L13">13</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="c">% function PushResults(IDPeaks,FitSim,totalSim,path,molecule)</span></div><div class='line' id='LC2'><span class="c">% Input : IDPeaks - spectral lines identified as peaks by PeakMatch, array</span></div><div class='line' id='LC3'><span class="c">%         FitSim - simulation results from LeastSquares, array</span></div><div class='line' id='LC4'><span class="c">%         totalSim - simulated spectrum, array</span></div><div class='line' id='LC5'><span class="c">%         path - path for data output, string</span></div><div class='line' id='LC6'><span class="c">%         molecule - molecule from fit, string</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="k">function</span><span class="w"> </span><span class="nf">PushResults</span><span class="p">(</span>IDPeaks,FitSim,totalSim,path,molecule<span class="p">)</span><span class="w"></span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><span class="n">xlswrite</span><span class="p">(</span><span class="n">strcat</span><span class="p">(</span><span class="n">path</span><span class="p">,</span><span class="n">molecule</span><span class="p">,</span><span class="s">&#39;IDPeaks&#39;</span><span class="p">),</span><span class="n">IDPeaks</span><span class="p">)</span></div><div class='line' id='LC11'><span class="n">xlswrite</span><span class="p">(</span><span class="n">strcat</span><span class="p">(</span><span class="n">path</span><span class="p">,</span><span class="n">molecule</span><span class="p">,</span><span class="s">&#39;Parameters&#39;</span><span class="p">),</span><span class="n">FitSim</span><span class="p">)</span></div><div class='line' id='LC12'><span class="n">xlswrite</span><span class="p">(</span><span class="n">strcat</span><span class="p">(</span><span class="n">path</span><span class="p">,</span><span class="n">molecule</span><span class="p">,</span><span class="s">&#39;totalSim&#39;</span><span class="p">),</span><span class="n">totalSim</span><span class="p">)</span></div><div class='line' id='LC13'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.14266s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.14500' data-host='fe3'></span>
  </body>
</html>
