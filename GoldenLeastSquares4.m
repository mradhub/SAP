function GoldenOutput = GoldenLeastSquares4(NTL,NTU,FWHML,FWHMU,tempL,tempU,shiftL,shiftU,molFreq,obsFreq,obsInt,AguList,A,EUJ)
...
%Temp3 third temperature fit
Tempa = TempFit-TempFit*.2;
Tempb = TempFit+TempFit*.2;
TempFit = 1;
TempSig = 1;
iteration = 1;
NT = NTFit;
...
%Shift3 third shift fit
Shifta = ShiftFit-abs(ShiftFit)*.1;
Shiftb = ShiftFit+abs(ShiftFit)*.1;
ShiftFit = 1;
ShiftSig = 1;
iteration = 1;
NT = NTFit;
...
%FWHM3 third FWHM fit
FWHMa = FWHMFit-FWHMFit*.15;
FWHMb = FWHMFit+FWHMFit*.15;
FWHMFit = 1;
FWHMSig = 1;
iteration = 1;
NT = NTFit;
