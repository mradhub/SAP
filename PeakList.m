...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>SAP/PeakList.m at f5277bf3ee75685f08917b7b8cd1d8c37f0756aa · mradhub/SAP</title>
...
<meta content="/EShUKdqbK9cV3w+olnYggPu/jfhS2t3kuRa874w0Fc=" name="csrf-token" />
    ...
    <script defer="defer" src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-0e05654676da76742ed92db3a771c57b6d399374.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/mradhub/SAP/blob/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PeakList.m'>
            ...
            <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field">
              <div class="no-results js-not-filterable">Nothing to show</div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/mradhub/SAP/blob/master/PeakList.m" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
            </div>
...
<!-- block_view_fragment_key: views10/v8/blob:v21:785bbfc4ae5b7c9d5bb3e2d8c271e841 -->
  <div id="slider">

    <div class="breadcrumb" data-path="PeakList.m/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/mradhub/SAP/tree/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa" class="js-rewrite-sha" itemprop="url"><span itemprop="title">SAP</span></a></b> / <strong class="final-path">PeakList.m</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="PeakList.m" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>


      <div class="commit file-history-tease" data-path="PeakList.m/">
        ...
        <time class="js-relative-date" datetime="2012-06-13T18:34:35-07:00" title="2012-06-13 18:34:35">June 13, 2012</time>
        <div class="commit-title">
            <a href="/mradhub/SAP/commit/d21de5acd15a99a537ac4376bb6c5306ba412d6c" class="message">day end 6-13-12</a>
        </div>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="PeakList.m/" data-permalink-url="/mradhub/SAP/blob/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PeakList.m" data-title="SAP/PeakList.m at f5277bf3ee75685f08917b7b8cd1d8c37f0756aa · mradhub/SAP · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/mradhub/SAP/edit/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PeakList.m" data-method="post" rel="nofollow" data-hotkey="e">Edit this file</a>
                  </li>

                <li>
                  <a href="/mradhub/SAP/raw/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PeakList.m" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span class="icon"></span>Raw</a>
                </li>
                  <li>
                    <a href="/mradhub/SAP/blame/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PeakList.m" class="minibutton btn-blame grouped-button bigger lighter"><span class="icon"></span>Blame</a>
                  </li>
                <li>
                  <a href="/mradhub/SAP/commits/f5277bf3ee75685f08917b7b8cd1d8c37f0756aa/PeakList.m" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span class="icon"></span>History</a>
                </li>
              </ul>
            </div>
...
<span id="L26" rel="#L26">26</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="c">% function Peaks = PeakList(DatCal,threshold)</span></div><div class='line' id='LC2'><span class="c">% Input : DatCal - Calibrated observational data</span></div><div class='line' id='LC3'><span class="c">%         threshold - minimum threshold intensity for peak.  This should be</span></div><div class='line' id='LC4'><span class="c">%         3-sigma of noise</span></div><div class='line' id='LC5'><span class="c">% Output: Peaks(1,:) - Frequencies of peaks in observational data</span></div><div class='line' id='LC6'><span class="c">%         Peaks(2,:) - intensities of peaks in observational data</span></div><div class='line' id='LC7'><span class="c">%         Peaks(3,:) - 1 if data point is a peak, 0 if not a peak</span></div><div class='line' id='LC8'><span class="c">%         PeakList(1,:) - Frequencies of peaks in observational data</span></div><div class='line' id='LC9'><span class="c">%         PeakList(2,:) - intensities of peaks in observational data</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'><span class="k">function</span><span class="w"> </span>[Peaks,PeaksList] <span class="p">=</span><span class="w"> </span><span class="nf">PeakList</span><span class="p">(</span>DatCal,threshold<span class="p">)</span><span class="w"></span></div><div class='line' id='LC12'><span class="n">Peaks</span><span class="p">=</span><span class="nb">zeros</span><span class="p">(</span><span class="nb">length</span><span class="p">(</span><span class="n">DatCal</span><span class="p">(:,</span>1<span class="p">)),</span>3<span class="p">);</span></div><div class='line' id='LC13'><span class="n">m</span><span class="p">=</span>2<span class="p">;</span></div><div class='line' id='LC14'><span class="n">n</span><span class="p">=</span>1<span class="p">;</span></div><div class='line' id='LC15'><span class="k">while</span><span class="p">(</span><span class="n">m</span><span class="o">&lt;</span><span class="nb">length</span><span class="p">(</span><span class="n">DatCal</span><span class="p">))</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;<span class="k">if</span><span class="p">(</span><span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="o">-</span>1<span class="p">,</span><span class="k">end</span><span class="p">)</span><span class="o">&lt;</span><span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span><span class="k">end</span><span class="p">)</span> <span class="o">&amp;&amp;</span> <span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="o">+</span>1<span class="p">,</span><span class="k">end</span><span class="p">)</span><span class="o">&lt;</span><span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span><span class="k">end</span><span class="p">)</span> <span class="o">&amp;&amp;</span> <span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span><span class="k">end</span><span class="p">)</span><span class="o">&gt;</span><span class="n">threshold</span><span class="p">)</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">Peaks</span><span class="p">(</span><span class="n">m</span><span class="p">,</span>1<span class="p">)=</span><span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span>1<span class="p">);</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">PeaksList</span><span class="p">(</span><span class="n">n</span><span class="p">,</span>1<span class="p">)</span> <span class="p">=</span> <span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span>1<span class="p">);</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">Peaks</span><span class="p">(</span><span class="n">m</span><span class="p">,</span>2<span class="p">)=</span><span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span><span class="k">end</span><span class="p">);</span></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">PeaksList</span><span class="p">(</span><span class="n">n</span><span class="p">,</span>2<span class="p">)=</span><span class="n">DatCal</span><span class="p">(</span><span class="n">m</span><span class="p">,</span><span class="k">end</span><span class="p">);</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">Peaks</span><span class="p">(</span><span class="n">m</span><span class="p">,</span>3<span class="p">)=</span>1<span class="p">;</span></div><div class='line' id='LC22'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">n</span><span class="p">=</span><span class="n">n</span><span class="o">+</span>1<span class="p">;</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;<span class="n">m</span><span class="p">=</span><span class="n">m</span><span class="o">+</span>1<span class="p">;</span></div><div class='line' id='LC25'><span class="k">end</span></div><div class='line' id='LC26'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.13795s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.14039' data-host='fe3'></span>
  </body>
</html>
