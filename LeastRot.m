...
function RotSim = LeastRot(NTL, NTU, FWHML, FWHMU, tempL, tempU, shiftL, shiftU, molFreq, obsFreq, obsInt, AguList, A, EUJ)
...
[IDPeaks]=PeakLite(obsFreq,obsInt,molFreq,AguList,EUJ,Peaks(:,end),Simulation,25);
k =  1.38065e-23;
h = 6.62606E-34; 
c = 2.9979E+8;
const = (8*pi*k*1.064*FitSim(7)*1E8)/(h*c^2);
lnstuff = ln((IDPeaks(:,3)*IDPeaks(:,1)*const)/IDPeaks(:,4));
EUK = IDPeaks(:,5)/k;
